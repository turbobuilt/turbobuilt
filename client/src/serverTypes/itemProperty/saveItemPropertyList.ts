...
export default function saveItemPropertyList(itemGuid: string, clientItemPropertyList: (ItemProperty & { builtIn?: boolean, typeName?: string })[], websiteGuid?: string) {
    return callMethod("itemProperty.saveItemPropertyList", [...arguments]) as Promise<{ error?: string, data: import("/home/me/turbobuilt/server/src/methods/itemProperty/ItemProperty.model").ItemProperty[] }>;
};
