...
async function uploadFiles(files: File[], onProgress: (progressData: ProgressData) => void) {
...
export function uploadFilePut(file, presignedUrl, onProgress: (percentComplete: number) => void): Promise<{ error?: any, data?: any }> {
