...
<template>
    <div class="file-input" ref="root" @click="fileInput.click()" @dragover="dragOver" @dragleave="dragLeave" @drop="drop">
        <div v-if="!loading">{{ label }}</div>
        <div v-else><v-progress-circular indeterminate :size="18" /></div>
    </div>
</template>
<style lang="scss">
.file-input {
